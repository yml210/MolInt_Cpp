...
**
** Created: Sat Oct 15 22:44:35 2011
...
static const char qt_meta_stringdata_Dialog1[] = {
    "Dialog1\0\0changeAtom(int)\0applied()\0"
};

const QMetaObject Dialog1::staticMetaObject = {
    { &MyDialog::staticMetaObject, qt_meta_stringdata_Dialog1,
...
int Dialog1::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: changeAtom((*reinterpret_cast< int(*)>(_a[1]))); break;
